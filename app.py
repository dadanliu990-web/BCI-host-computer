...
# from topoMapForm import TopoMapForm  # 暂时禁用头皮拓扑图
...
if __name__ == "__main__":
    ...
    w.af = af
    w.topo = topo
    # impf._mw = w  # 已注销: 阻抗检测功能
    print("[3/4] attributes assigned OK", flush=True)
    print("[3/4] Creating Controller...", flush=True)
    w.controller = Controller(w, cf, sf, impForm=impf, bpForm=bpf, sgForm=sgf, accForm=af, topoForm=None)
